...
void make_qua_file(std::string name, const std::vector<double>& y, 
...
std::string read_qua_header(std::vector<std::string>& column_name, int& nind, int& ntrt, std::istream& inp);

std::string read_qua_file(std::vector<std::string>& column_name,
