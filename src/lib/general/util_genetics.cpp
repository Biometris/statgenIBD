...
IndProp::IndProp(std::string id, std::string fam, std::string type, std::string par1, std::string par2)
...
bool match(int& x, const string& str, const char * pat)
{
	string pattern(pat);
...
bool match(int& x, int& y, const string& str, const char * pat)
{
	string pattern(pat);
